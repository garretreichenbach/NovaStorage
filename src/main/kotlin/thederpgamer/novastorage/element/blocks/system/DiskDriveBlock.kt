...
private val BASE_CAPACITY = configReloadable { NovaConfig[Blocks.DISK_DRIVE].getLong("base_energy_capacity") }
private val BASE_USAGE = configReloadable { NovaConfig[Blocks.DISK_DRIVE].getLong("base_energy_usage") }
